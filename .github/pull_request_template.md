...
- [ ] The ticket named in the title is LINKED in *Related* above, cross-repo as `Closes tracebloc/<repo>#N` — a bare `#N` resolves against this repo, and a title reference alone links nothing
